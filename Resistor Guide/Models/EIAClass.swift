...
enum EIAClass {
	case None, E3, E6, E12, E24, E48, E96, E192

	typealias Mantissa = UInt16
	typealias Tolerance = UInt16

	// E3, E6, E12, E24
	private static let e24Table: [Mantissa] = [
		100, 110, 120, 130, 150, 160, 180, 200,
		220, 240, 270, 300, 330, 360, 390, 430,
		470, 510, 560, 620, 680, 750, 820, 820
	]

	// E48, E96, E192
	private static let e192Table: [Mantissa] = [
	...
	static func classify(mantissa: Mantissa, tolerance: UInt) -> EIAClass {
		let result: EIAClass = {
			if mantissa == 0 {
				switch tolerance {
				...
				default: return (tolerance <= 0_50 && tolerance > 0) ? .E192 : .None
				}
			}
			...
			if e192Idx != e192Table.endIndex {
				if e192Idx % 4 == 0 {
					...
					return (tolerance <= 0_50 && tolerance > 0) ? .E192 : .None
				}
			}
			return .None
		}()
